...
namespace csharp_fundamentals_arrays.Main
{
    public class Core
    {
        // The block of code below is a method definition. So far, you've been using methods created by other people such as .length() and .charAt(n)
        // From this exercise on, you'll be writing code inside methods very often! Methods are a container for a specific piece of logic that the class can run. For now, just implement your solutions between the comments that look like:
        ...
        public String two()
        {
            ...
            //TODO: 2. Using an array index, change the value of the teacher variable below to be the fourth teacher contained in the teachers array
